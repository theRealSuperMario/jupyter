...
<figure class="half", align="center">
    ...
    <figcaption>Data points $P$ corrupted with different errors and their model estimates $M$.</figcaption>
</figure>

<!-- Translate the above block automatically into the below block and add Fig.1: -->
<!-- {% include gallery id="data_errors" caption="Fig.1: Data points $P$ corrupted with different errors and their model estimates $M$." %} -->
...
<figure class="half", align="center">
    ...
    <a href="02_Vanilla_RANSAC/seed_42_n2_t5/animation.gif"><img src="02_Vanilla_RANSAC/seed_42_n2_t5/animation.gif" width=400></a>
    <figcaption>Vanilla RANSAC iteration.</figcaption>
</figure>


<!-- {% include gallery id="vanilla_ransac" caption="Fig.2: Vanilla RANSAC iteration." %} -->
...
<figure class="half", align="center">
    ...
    <figcaption>The expected size of the consensus set $T$ influences the model selection.</figcaption>
</figure>
<!-- {% include gallery id="t_impact" caption="Fig.3: If size of consensus set $t$ for termination is chosen too small, a bad model can be accepted erroneously." %} -->
...
<figure class="half", align="center">
    ...
    <a href="03_Homography_Estimation/scene.jpg"><img src="03_Homography_Estimation/scene.jpg" width=400></a>
    <figcaption>We want to find the left template in the right scene.</figcaption>
</figure>
<!-- {% include gallery id="homography_example" caption="Fig.4: We want to find the left template in the right scene." %} -->
...
<!-- {% include gallery id="homography_results" caption="Fig.5: Using RANSAC, we can find the correct homography (left) and reject wrong outlier points (right)."%} -->
